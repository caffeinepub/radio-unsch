...
function AnimatedBackground({ isPlaying }) {
  ...
  reactExports.useEffect(() => {
    ...
    const draw = (ts) => {
      ...
      for (let i = 0; i < 3; i++) {
        const phase = (ts / 4e3 + i * 1.2) % (Math.PI * 2);
        ctx.save();
        ...
        ctx.moveTo(0, h);
        for (let x = 0; x <= w; x += 8) {
          const y = h * 0.35 + Math.sin(x / 180 + phase + i * 0.8) * (h * 0.06) + Math.cos(x / 90 + phase * 0.7) * (h * 0.03);
          ctx.lineTo(x, y);
        }
        ctx.lineTo(w, h);
        ctx.closePath();
  ...
  reactExports.useEffect(() => {
    ...
    const draw = (now2) => {
      ...
      for (let i = 0; i < BARS; i++) {
        ...
        if (isPlaying) {
          b.ph += b.spd * dt / 1e3;
          const freqShape = i < 5 ? 0.9 : i < 10 ? 1 : i < 18 ? 0.75 : 0.5;
          b.target = 4 + (MAX_H - 4) * freqShape * (0.45 + 0.55 * Math.abs(Math.sin(b.ph)));
          const chaos = Math.sin(b.ph * 2.3) * 0.2;
          b.target = Math.max(4, b.target + chaos * MAX_H * 0.15);
        } else {
          b.target = 4;
        }
        b.h += (b.target - b.h) * Math.min(1, dt / 1e3 * 8);
        const x = i * (barW + 1);
...
function RadioDesign2() {
  ...
  const songTitle = (meta == null ? void 0 : meta.title) || (isPlaying ? "Cargando..." : "Presiona play");
  const artistName = (meta == null ? void 0 : meta.artist) || "Radio UNSCH";
  const albumArt = (meta == null ? void 0 : meta.art) || "";
  const albumName = (meta == null ? void 0 : meta.album) || "";
  const nextTitle = (meta == null ? void 0 : meta.nextTitle) || "";
  const nextArtist = (meta == null ? void 0 : meta.nextArtist) || "";
  const listeners = (meta == null ? void 0 : meta.listeners) || 0;
  const duration = (meta == null ? void 0 : meta.duration) || 0;
  reactExports.useEffect(() => {
    if ((meta == null ? void 0 : meta.elapsed) !== void 0) {
      setElapsed(meta.elapsed);
      elapsedRef.current = meta.elapsed;
    }
  }, [meta == null ? void 0 : meta.elapsed]);
  reactExports.useEffect(() => {
    if (isPlaying) {
  ...
  reactExports.useEffect(() => {
    if (isPlaying) {
      const animate = (ts) => {
        ...
        rotRef.current = (rotRef.current + dt / 1e3 * 20) % 360;
  ...
  const startAudioCtx = reactExports.useCallback(() => {
    try {
  ...
  const resumeAudioCtx = reactExports.useCallback(() => {
    try {
  ...
  const stopAudioCtx = reactExports.useCallback(() => {
    var _a2, _b2, _c2;
    try {
      (_a2 = oscRef.current) == null ? void 0 : _a2.stop();
      (_b2 = oscRef.current) == null ? void 0 : _b2.disconnect();
      oscRef.current = null;
  ...
  const stopKeepAlive = reactExports.useCallback(() => {
    var _a2;
  ...
  const startKeepAlive = reactExports.useCallback(() => {
    stopKeepAlive();
    const tick = () => {
      var _a2;
      resumeAudioCtx();
  ...
  reactExports.useEffect(() => {
    const onVisible = () => {
      ...
      if (document.visibilityState === "visible") {
        ...
        (_b2 = audioRef.current) == null ? void 0 : _b2.play().catch(() => {
        });
        resumeAudioCtx();
      }
    };
  ...
  const setupMediaSession = reactExports.useCallback(() => {
    ...
    navigator.mediaSession.metadata = new MediaMetadata({
      title: (meta == null ? void 0 : meta.title) || "En Vivo",
      artist: (meta == null ? void 0 : meta.artist) || "Radio UNSCH",
      album: "Radio UNSCH",
      artwork: [
        {
  ...
  const handleToggle = async () => {
    ...
    if (isPlaying) {
      ...
      silent == null ? void 0 : silent.pause();
      stopAudioCtx();
      stopKeepAlive();
      releaseWakeLock();
      setIsPlaying(false);
  ...
  const progressPct = isPlaying && duration > 0 ? Math.min(elapsed / duration * 100, 100) : 0;
  const currentVol = isMuted ? 0 : volume;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-screen w-screen flex flex-col items-center justify-center relative overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedBackground, { isPlaying }),
      ...
      "audio",
      {
        ...
        onPause: () => {
          ...
          if (isPlayingRef.current)
            (_a2 = audioRef.current) == null ? void 0 : _a2.play().catch(() => attemptResume());
        },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("audio", { ref: silentRef, src: SILENT_SRC, preload: "auto", playsInline: true, loop: true }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "cosmos-card w-full mx-4", style: { maxWidth: "22rem" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-4 right-4 flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center mt-6 mb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "h1",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-center my-3 relative", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              ...
              boxShadow: isPlaying ? "0 0 0 4px rgba(0,150,180,0.8), 0 0 60px rgba(0,100,130,0.6)" : "0 0 0 2px rgba(0,80,100,0.4), 0 0 30px rgba(0,50,70,0.3)"
            },
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { height: 52, margin: "0 0 4px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(EQCanvas, { isPlaying: isPlaying && status === "playing" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "metadata-panel", children: [
        status === "loading" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
        ...
        ) : status === "error" ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-center py-2", style: { color: "#e55" }, children: errorMsg }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
          ...
          albumName && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              className: "text-xs",
              style: {
        ...
        isPlaying && duration > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              height: 3,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mt-2.5 gap-2", children: [
          nextTitle ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(SkipForward, { className: "w-3 h-3 shrink-0" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "span",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { color: "rgba(0,140,165,0.9)" }, children: [
                        "A continuación:",
                        " "
                      ] }),
                      nextTitle,
          ...
          isPlaying && listeners > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { className: "w-2.5 h-2.5", style: { color: "#00a0b8" } }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    className: "text-xs",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5 w-full mt-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            ...
            children: isMuted || volume === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(VolumeX, { className: "w-4 h-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Volume2, { className: "w-4 h-4" })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center mt-3 mb-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          ...
          children: status === "loading" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Radio, { className: "w-9 h-9 animate-pulse" }) : isPlaying ? /* @__PURE__ */ jsxRuntimeExports.jsx(Pause, { className: "w-9 h-9" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { className: "w-9 h-9 ml-1" })
        }
      ) })
    ] })
  ] });
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(RadioDesign2, {});
}

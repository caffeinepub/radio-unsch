...
const Music = createLucideIcon("music", __iconNode$5);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function useRadioMetadata() {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      return {
        title: ((_b2 = (_a2 = data.now_playing) == null ? void 0 : _a2.song) == null ? void 0 : _b2.title) ?? "",
        artist: ((_d2 = (_c2 = data.now_playing) == null ? void 0 : _c2.song) == null ? void 0 : _d2.artist) ?? "",
        album: ((_f2 = (_e2 = data.now_playing) == null ? void 0 : _e2.song) == null ? void 0 : _f2.album) ?? "",
        art: ((_h2 = (_g2 = data.now_playing) == null ? void 0 : _g2.song) == null ? void 0 : _h2.art) ?? "",
        genre: ((_j2 = (_i2 = data.now_playing) == null ? void 0 : _i2.song) == null ? void 0 : _j2.genre) ?? "",
        listeners: ((_k = data.listeners) == null ? void 0 : _k.total) ?? 0,
        elapsed: ((_l = data.now_playing) == null ? void 0 : _l.elapsed) ?? 0,
        duration: ((_m = data.now_playing) == null ? void 0 : _m.duration) ?? 0,
        remaining: ((_n = data.now_playing) == null ? void 0 : _n.remaining) ?? 0,
        nextTitle: ((_p = (_o = data.playing_next) == null ? void 0 : _o.song) == null ? void 0 : _p.title) ?? "",
        nextArtist: ((_r = (_q = data.playing_next) == null ? void 0 : _q.song) == null ? void 0 : _r.artist) ?? "",
        nextArt: ((_t = (_s = data.playing_next) == null ? void 0 : _s.song) == null ? void 0 : _t.art) ?? "",
...
function useRadioPlayer() {
  ...
  const silentAudioRef = reactExports.useRef(null);
  ...
  const keepAliveIntervalRef = reactExports.useRef(
    null
  );
  const volumeRef = reactExports.useRef(80);
  ...
  const songTitle = (metadata == null ? void 0 : metadata.title) || "Radio UNSCH - En Vivo";
  const artistName = (metadata == null ? void 0 : metadata.artist) || "Radio UNSCH";
  const albumName = (metadata == null ? void 0 : metadata.album) || "";
  const albumArt = (metadata == null ? void 0 : metadata.art) || "";
  const elapsed = (metadata == null ? void 0 : metadata.elapsed) ?? 0;
  const duration = (metadata == null ? void 0 : metadata.duration) ?? 0;
  const remaining = (metadata == null ? void 0 : metadata.remaining) ?? 0;
  const nextTitle = (metadata == null ? void 0 : metadata.nextTitle) || "";
  const nextArtist = (metadata == null ? void 0 : metadata.nextArtist) || "";
  reactExports.useEffect(() => {
    isPlayingRef.current = isPlaying;
  }, [isPlaying]);
  const startAudioContextKeepalive = reactExports.useCallback(() => {
    try {
  ...
  const ensureAudioContextKeepalive = reactExports.useCallback(() => {
    try {
  ...
  const stopAudioContextKeepalive = reactExports.useCallback(() => {
    try {
      if (oscillatorRef.current) {
  ...
  const acquireWakeLock = reactExports.useCallback(async () => {
    try {
  ...
  const attemptResume = reactExports.useCallback(
    (attempt = 0) => {
      const audio = audioRef.current;
      if (!audio || !isPlayingRef.current) return;
      audio.play().catch(() => {
        if (attempt < 10) {
          const delay = Math.min(500 * (attempt + 1), 3e3);
  ...
  const stopKeepAliveInterval = reactExports.useCallback(() => {
  ...
  const startKeepAliveInterval = reactExports.useCallback(() => {
    ...
    keepAliveIntervalRef.current = setInterval(() => {
      ...
      if (sa == null ? void 0 : sa.paused) sa.play().catch(() => {
      });
      if (((_a2 = audioRef.current) == null ? void 0 : _a2.paused) && isPlayingRef.current) attemptResume();
  ...
  reactExports.useEffect(() => {
    const handleVisibilityChange = () => {
      if (document.visibilityState === "visible") {
        const audio = audioRef.current;
        if (isPlayingRef.current && (audio == null ? void 0 : audio.paused)) attemptResume();
        const ctx = audioContextRef.current;
        if ((ctx == null ? void 0 : ctx.state) === "suspended") ctx.resume().catch(() => {
        });
        if (isPlayingRef.current) acquireWakeLock();
        ...
        if (isPlayingRef.current) {
          audio == null ? void 0 : audio.play().catch(() => {
          });
          const ctx = audioContextRef.current;
          if ((ctx == null ? void 0 : ctx.state) === "suspended") ctx.resume().catch(() => {
          });
    ...
    const handleFreeze = () => {
      const audio = audioRef.current;
      if (isPlayingRef.current && (audio == null ? void 0 : audio.paused)) audio.play().catch(() => {
      });
    };
    const handleResume = () => {
      const audio = audioRef.current;
    ...
    const handlePageHide = () => {
      var _a2;
      if (isPlayingRef.current) (_a2 = audioRef.current) == null ? void 0 : _a2.play().catch(() => {
      });
    };
    const handlePageShow = () => {
      var _a2;
      if (isPlayingRef.current && ((_a2 = audioRef.current) == null ? void 0 : _a2.paused)) attemptResume();
    };
  ...
  const setupMediaSession = reactExports.useCallback(() => {
    ...
    navigator.mediaSession.setActionHandler("play", () => {
      var _a2;
      (_a2 = audioRef.current) == null ? void 0 : _a2.play().then(() => {
        setIsPlaying(true);
        setStatus("playing");
        navigator.mediaSession.playbackState = "playing";
      }).catch(() => {
...
function EQ({ isPlaying }) {
  const canvasRef = reactExports.useRef(null);
  const animRef = reactExports.useRef(null);
  const barsRef = reactExports.useRef(
    Array.from({ length: 20 }, (_, i) => {
      ...
      return {
        ...
        maxH: isBass ? 1 : isTreble ? 0.6 : 0.85,
        changeTimer: 0,
  ...
  reactExports.useEffect(() => {
    ...
    const draw = () => {
      ...
      if (!isPlaying) {
        for (let i = 0; i < N; i++) {
          const x = i * (barW + 2);
          ctx.fillStyle = "rgba(0,95,107,0.25)";
          ctx.beginPath();
          ctx.roundRect(x, H - 3, barW, 3, 2);
          ctx.fill();
        }
        return;
      }
      for (let i = 0; i < N; i++) {
        ...
        grad.addColorStop(0, "#7dd3de");
        grad.addColorStop(0.5, "#2a9aaa");
        ...
        ctx.fill();
        if (bar.peak > 0.06) {
          ctx.fillStyle = "rgba(125,211,222,0.75)";
          ctx.beginPath();
...
function RadioDesign1() {
  ...
  const {
    ...
    audioRef,
    silentAudioRef,
    SILENT_AUDIO_SRC: SILENT_AUDIO_SRC2,
    LOGO_URL: LOGO_URL2
  } = player;
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: "radial-gradient(ellipse 80% 70% at 50% 40%, rgba(0,120,130,0.18) 0%, rgba(0,80,90,0.06) 50%, transparent 80%)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "fixed inset-0 -z-10 pointer-events-none",
            style: {
              background: "radial-gradient(ellipse 40% 30% at 50% 0%, rgba(0,180,200,0.08) 0%, transparent 70%)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "audio",
          {
            ...
            onError: () => {
              var _a2;
              if ((_a2 = audioRef.current) == null ? void 0 : _a2.__isPlaying) scheduleReconnect();
            },
            onStalled: () => scheduleReconnect(),
            onEnded: () => scheduleReconnect(),
            onPause: () => {
              var _a2;
              if ((_a2 = audioRef.current) == null ? void 0 : _a2.__isPlaying) attemptResume();
            },
            onPlay: () => {
            },
            onWaiting: () => {
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                style: {
                  background: "rgba(0,18,20,0.6)",
                  backdropFilter: "blur(40px) saturate(180%)",
                  boxShadow: "0 0 80px rgba(0,120,140,0.12), 0 2px 0 rgba(0,200,220,0.06) inset, 0 -1px 0 rgba(0,100,120,0.06) inset",
                  border: "1px solid rgba(0,150,170,0.1)"
                },
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mt-4", children: [
                    isPlaying && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        ...
                        style: {
                          border: "1.5px solid rgba(0,150,170,0.4)",
                          margin: "-10px"
                        }
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        ...
                        style: {
                          boxShadow: isPlaying ? "0 0 0 3px rgba(0,140,160,0.5), 0 0 50px rgba(0,120,140,0.3)" : "0 0 0 2px rgba(0,80,90,0.2)"
                        },
                        children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "img",
                          {
                            src: albumArt || LOGO_URL2,
                            alt: "Radio UNSCH",
                            className: "w-full h-full object-cover",
                            loading: "eager",
                            onError: (e) => {
                              e.currentTarget.src = LOGO_URL2;
                            }
                          }
                        )
                      }
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(EQ, { isPlaying: isPlaying && status === "playing" })
                    }
                  ),
                      ...
                      children: [
                        status === "loading" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "div",
                          {
                            ...
                            style: { color: "#3a7a85" },
                            children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx(Radio, { className: "w-4 h-4 animate-pulse" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: errorMsg || "Conectando..." })
                            ]
                          }
                        ) : status === "error" ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-center", style: { color: "#b05050" }, children: errorMsg }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "p",
                            {
                              className: "text-sm font-semibold leading-snug",
                              style: { color: "#7dd3de" },
                              children: metaLoading && !isPlaying ? "En vivo - Radio UNSCH" : songTitle
                            }
                          ),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(Music, { className: "w-3 h-3", style: { color: "#2a9aaa" } }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", style: { color: "#5aa8b8" }, children: artistName })
                          ] }),
                          albumName && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px]", style: { color: "#3a7a85" }, children: albumName })
                        ] }),
                        duration > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                              className: "w-full rounded-full overflow-hidden",
                              style: { height: "2px", background: "rgba(0,80,95,0.2)" },
                              children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "div",
                                {
                                  style: {
                                    ...
                                    background: "linear-gradient(90deg,#2a7a8a,#5ab8c8)",
                                    borderRadius: "9999px",
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between mt-1", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              ...
                              {
                                className: "text-[9px]",
                                style: { color: "rgba(90,168,184,0.5)" },
                        ...
                        nextTitle && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "p",
                          {
                            className: "text-[9px] mt-1.5",
                            style: { color: "rgba(0,120,140,0.65)" },
                            children: [
                              "A continuación:",
                              " ",
                              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { color: "rgba(90,168,184,0.6)" }, children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full flex items-center gap-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        type: "button",
                        ...
                        children: isMuted || volume === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(VolumeX, { className: "w-3.5 h-3.5" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Volume2, { className: "w-3.5 h-3.5" })
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "input",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "span",
                      {
                        ...
                        style: { color: "rgba(0,120,140,0.6)" },
                        children: [
                          currentVolume,
                          "%"
                        ]
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      ...
                      style: {
                        background: isPlaying ? "rgba(0,120,140,0.15)" : "rgba(0,80,100,0.1)",
                        border: "2px solid rgba(0,160,180,0.4)",
                        boxShadow: isPlaying ? "0 0 30px rgba(0,160,180,0.2), 0 0 0 6px rgba(0,120,140,0.08)" : "0 0 16px rgba(0,120,140,0.15)",
                        color: "#7dd3de"
                      },
                      children: status === "loading" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Radio, { className: "w-7 h-7 animate-pulse" }) : isPlaying ? /* @__PURE__ */ jsxRuntimeExports.jsx(Pause, { className: "w-7 h-7" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { className: "w-7 h-7 ml-1" })
                    }
                  )
                ]
              }
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "fixed inset-0 -z-10 pointer-events-none",
            style: {
              background: "radial-gradient(ellipse 70% 60% at 50% 60%, rgba(160,80,0,0.14) 0%, rgba(120,50,0,0.05) 55%, transparent 80%)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "fixed inset-0 -z-10 pointer-events-none",
            style: {
              background: "radial-gradient(ellipse 30% 20% at 50% 100%, rgba(200,100,0,0.08) 0%, transparent 70%)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "audio",
          {
            ...
            onPause: () => {
              var _a2;
              if ((_a2 = audioRef.current) == null ? void 0 : _a2.__playing) attemptResume();
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                style: {
                  ...
                  boxShadow: "0 0 80px rgba(180,90,0,0.1), 0 2px 0 rgba(220,140,0,0.06) inset",
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mt-4", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        className: `w-40 h-40 rounded-full overflow-hidden ${isPlaying ? "vinyl-spinning" : ""}`,
                        style: {
                          boxShadow: isPlaying ? "0 0 0 3px rgba(180,100,0,0.5), 0 0 50px rgba(160,80,0,0.25)" : "0 0 0 2px rgba(120,60,0,0.2)"
                        },
                        children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "img",
                          {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(EQAmber, { isPlaying: isPlaying && status === "playing" })
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        status === "loading" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(Music, { className: "w-3 h-3", style: { color: "#c08030" } }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", style: { color: "#b07840" }, children: artistName })
                          ] }),
                          albumName && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px]", style: { color: "#806030" }, children: albumName })
                        ] }),
                        duration > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                        ...
                        nextTitle && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "p",
                          {
                            ...
                            children: [
                              "A continuación:",
                              " ",
                              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { color: "rgba(200,150,60,0.65)" }, children: [
                                nextArtist && `${nextArtist} — `,
                                nextTitle
                              ] })
                            ]
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      ...
                      className: "play-btn w-20 h-20 rounded-full flex items-center justify-center disabled:opacity-50",
                      style: {
                        background: isPlaying ? "rgba(160,80,0,0.18)" : "rgba(100,50,0,0.12)",
                        border: "2px solid rgba(200,130,0,0.4)",
                        boxShadow: isPlaying ? "0 0 30px rgba(200,120,0,0.2), 0 0 0 6px rgba(180,90,0,0.07)" : "0 0 16px rgba(180,90,0,0.12)",
                        color: "#d4a040"
                      },
                      children: status === "loading" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Radio, { className: "w-7 h-7 animate-pulse" }) : isPlaying ? /* @__PURE__ */ jsxRuntimeExports.jsx(Pause, { className: "w-7 h-7" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { className: "w-7 h-7 ml-1" })
                    }
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "fixed inset-0 -z-10 pointer-events-none",
            style: {
              background: "radial-gradient(ellipse 75% 65% at 50% 45%, rgba(90,40,160,0.2) 0%, rgba(60,20,120,0.07) 55%, transparent 80%)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "fixed inset-0 -z-10 pointer-events-none",
            style: {
              background: "radial-gradient(ellipse 35% 25% at 30% 20%, rgba(120,60,200,0.08) 0%, transparent 70%)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "fixed inset-0 -z-10 pointer-events-none",
            style: {
              background: "radial-gradient(ellipse 25% 20% at 75% 80%, rgba(80,40,180,0.07) 0%, transparent 70%)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                style: {
                  ...
                  backdropFilter: "blur(40px) saturate(180%)",
                  boxShadow: "0 0 80px rgba(100,40,200,0.12), 0 2px 0 rgba(160,100,255,0.05) inset",
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mt-4", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        className: `w-40 h-40 rounded-full overflow-hidden ${isPlaying ? "vinyl-spinning" : ""}`,
                        style: {
                          boxShadow: isPlaying ? "0 0 0 3px rgba(100,40,200,0.55), 0 0 50px rgba(90,30,180,0.3)" : "0 0 0 2px rgba(80,30,150,0.2)"
                        },
                        children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "img",
                          {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(EQViolet, { isPlaying: isPlaying && status === "playing" })
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        status === "loading" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(Music, { className: "w-3 h-3", style: { color: "#8b5cf6" } }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", style: { color: "#a78bfa" }, children: artistName })
                          ] }),
                          albumName && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px]", style: { color: "#7c6ca0" }, children: albumName })
                        ] }),
                        duration > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                        ...
                        nextTitle && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "p",
                          {
                            ...
                            children: [
                              "A continuación:",
                              " ",
                              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { color: "rgba(160,120,240,0.65)" }, children: [
                                nextArtist && `${nextArtist} — `,
                                nextTitle
                              ] })
                            ]
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      ...
                      className: "play-btn w-20 h-20 rounded-full flex items-center justify-center disabled:opacity-50",
                      style: {
                        background: isPlaying ? "rgba(100,40,200,0.18)" : "rgba(70,20,160,0.1)",
                        border: "2px solid rgba(140,80,240,0.4)",
                        boxShadow: isPlaying ? "0 0 30px rgba(120,50,220,0.25), 0 0 0 6px rgba(100,40,200,0.07)" : "0 0 16px rgba(100,40,200,0.12)",
                        color: "#c4b5fd"
                      },
                      children: status === "loading" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Radio, { className: "w-7 h-7 animate-pulse" }) : isPlaying ? /* @__PURE__ */ jsxRuntimeExports.jsx(Pause, { className: "w-7 h-7" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { className: "w-7 h-7 ml-1" })
                    }
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: designs.map((d) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-12", children: [
          active === 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(RadioDesign1, {}),
          active === 2 && /* @__PURE__ */ jsxRuntimeExports.jsx(RadioDesign2, {}),
          active === 3 && /* @__PURE__ */ jsxRuntimeExports.jsx(RadioDesign3, {})
        ] })
      ]
    }
  );
...
Service({
  "fetchRadioMetadata": Func([], [Metadata], []),
  "transform": Func(
    [TransformationInput],

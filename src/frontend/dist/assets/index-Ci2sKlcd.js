...
function EQCoral({ isPlaying }) {
  const canvasRef = reactExports.useRef(null);
  const barsRef = reactExports.useRef(Array.from({ length: 20 }, () => 0.08));
  const peaksRef = reactExports.useRef(Array.from({ length: 20 }, () => 0.08));
...
function LightDesign1() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      style: {
        background: "linear-gradient(160deg, #faf7f4 0%, #fde8e2 55%, #fef3ee 100%)",
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              ...
              boxShadow: isPlaying ? "0 8px 40px rgba(224, 112, 85, 0.35), 0 2px 12px rgba(0,0,0,0.1)" : "0 4px 20px rgba(0,0,0,0.12)",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: "0.8rem", color: "#7a5548", fontWeight: 500 }, children: artistName }),
              nextTitle && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                    marginTop: 6,
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { fontSize: "0.68rem", color: "#a85040" }, children: [
                    "Siguiente: ",
                    nextTitle,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { width: "100%", maxWidth: 220 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(EQCoral, { isPlaying }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            style: {
              ...
              height: 72,
              borderRadius: "50%",
              background: isPlaying ? "linear-gradient(135deg, #c0392b, #e07055)" : "linear-gradient(135deg, #e07055, #f0a080)",
              border: "none",
              ...
              color: "#fff",
              boxShadow: isPlaying ? "0 6px 24px rgba(192, 57, 43, 0.4)" : "0 6px 24px rgba(224, 112, 85, 0.35)",
              transition: "all 0.2s",
              transform: status === "loading" ? "scale(0.95)" : "scale(1)",
              flexShrink: 0
            },
            children: status === "loading" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Music, { size: 28, style: { opacity: 0.8 }, className: "animate-spin" }) : isPlaying ? /* @__PURE__ */ jsxRuntimeExports.jsx(Pause, { size: 28 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { size: 28, style: { marginLeft: 3 } })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { fontSize: "0.6rem", color: "#c4a090", textAlign: "center" }, children: [
          "© ",
...
function LightDesign2() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      style: {
        background: "linear-gradient(145deg, #e8f4fd 0%, #f0f8ff 50%, #e0eef8 100%)",
        fontFamily: "'Figtree', sans-serif"
      },
      className: "h-full w-full flex flex-col overflow-hidden",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-row items-start gap-4 px-5 pt-5 pb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2 flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Radio, { size: 14, color: "#2563a8" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      style: {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-0.5", style: { marginTop: 4 }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  style: {
              ...
              albumName ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: "0.7rem", color: "#4a7aaa" }, children: albumName }) : null
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
                ...
                boxShadow: isPlaying ? "0 6px 28px rgba(37, 99, 168, 0.3)" : "0 3px 14px rgba(0,0,0,0.1)",
                transition: "box-shadow 0.5s",
                flexShrink: 0
              },
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-1 px-5 py-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(EQCielo, { isPlaying }),
          status === "loading" && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: "0.65rem", color: "#2563a8", opacity: 0.7 }, children: "Conectando..." })
        ] }),
        nextTitle && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  style: {
                    ...
                    height: 68,
                    borderRadius: "50%",
                    background: isPlaying ? "linear-gradient(135deg, #1e4a88, #2563a8)" : "linear-gradient(135deg, #2563a8, #4a90d9)",
                    border: "none",
                    cursor: status === "loading" ? "wait" : "pointer",
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                    color: "#fff",
                    boxShadow: isPlaying ? "0 6px 24px rgba(30, 74, 136, 0.45)" : "0 6px 24px rgba(37, 99, 168, 0.35)",
                    transition: "all 0.2s"
                  },
                  children: status === "loading" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Music, { size: 26, className: "animate-spin" }) : isPlaying ? /* @__PURE__ */ jsxRuntimeExports.jsx(Pause, { size: 26 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { size: 26, style: { marginLeft: 3 } })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "p",
...
function LightDesign3() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      style: {
        background: "linear-gradient(170deg, #f0f5f0 0%, #e8f2ea 60%, #f5faf5 100%)",
        fontFamily: "'Figtree', sans-serif"
      },
      className: "h-full w-full flex flex-col overflow-hidden",
      children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                    position: "absolute",
                    inset: 0,
                    backgroundImage: `url(${albumArt || LOGO_URL2})`,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: "0.78rem", color: "#2d6a4f", fontWeight: 600 }, children: artistName }),
              albumName ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: "0.7rem", color: "#5a9a72", marginTop: 2 }, children: albumName }) : null,
              nextTitle && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: { flexShrink: 0 },
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(EQJardin, { isPlaying })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  style: {
                    ...
                    height: 68,
                    borderRadius: "50%",
                    background: isPlaying ? "linear-gradient(135deg, #1b4332, #2d6a4f)" : "linear-gradient(135deg, #2d6a4f, #52b788)",
                    border: "none",
                    cursor: status === "loading" ? "wait" : "pointer",
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                    color: "#fff",
                    boxShadow: isPlaying ? "0 6px 24px rgba(27, 67, 50, 0.45)" : "0 6px 24px rgba(45, 106, 79, 0.4)",
                    transition: "all 0.2s"
                  },
                  children: status === "loading" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Music, { size: 26, className: "animate-spin" }) : isPlaying ? /* @__PURE__ */ jsxRuntimeExports.jsx(Pause, { size: 26 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { size: 26, style: { marginLeft: 3 } })
                }
...
function App() {
  const [active, setActive] = reactExports.useState("coral");
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-screen w-screen overflow-hidden flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        style: {
          background: active === "coral" ? "linear-gradient(135deg, #faf7f4 0%, #fde8e2 100%)" : active === "cielo" ? "linear-gradient(135deg, #e8f4fd 0%, #dbeafe 100%)" : "linear-gradient(135deg, #f0f5f0 0%, #d1fae5 100%)",
          borderBottom: active === "coral" ? "1px solid #f0d0c0" : active === "cielo" ? "1px solid #bfdbfe" : "1px solid #a7f3d0"
        },
        ...
        children: designs.map((d) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            style: {
              ...
              border: active === d.key ? `1.5px solid ${d.activeColor}` : "1.5px solid #ddd",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-h-0", children: [
      active === "coral" && /* @__PURE__ */ jsxRuntimeExports.jsx(LightDesign1, {}),
      active === "cielo" && /* @__PURE__ */ jsxRuntimeExports.jsx(LightDesign2, {}),
      active === "jardin" && /* @__PURE__ */ jsxRuntimeExports.jsx(LightDesign3, {})
    ] })
  ] });
}
